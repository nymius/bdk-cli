      ...
      in {
        ...
        packages = {
          ...
          bdk-cli = pkgs.rustPlatform.buildRustPackage {
            ...
            # HOME in the nix sandbox (/homeless-shelter) is not writable, but
            # bdk-cli creates a default wallet dir at startup even for pure commands.
            preCheck = ''
              export HOME=$TMPDIR
            '';
            ...
            # electrsd/bitcoind build scripts attempt to download binaries (network
            # unavailable in Nix). Skip the download; binaries resolve from PATH.
            ELECTRSD_SKIP_DOWNLOAD = "1";
            BITCOIND_SKIP_DOWNLOAD = "1";
            nativeCheckInputs = with pkgs; [electrs bitcoind];
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            # Ensure bdk-cli is first in PATH when in the devShell
            export PATH=${self.packages.${system}.bdk-cli}/bin:$PATH
